      ...
      >
        ...
        <Box className="product-right" orientation={"vertical"}>
          ...
          <Typography level="body-sm" className="product-description">
            Whey Protein Concentrate and Isolate Powder with Digestive Enzymes
            and ElectrolytesSupports Healthy Metabolism and Lean Muscle Recovery
          </Typography>
